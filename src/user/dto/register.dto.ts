import { IsBoolean, IsEmail, IsNotEmpty, IsNumberString, IsOptional, IsString, Length, Matches } from 'class-validator';
import { Match } from '../decorator/password-match.decorator';
import { ApiProperty } from '@nestjs/swagger';

export class RegisterDto {
  @ApiProperty({
    example: 'jskim4695@gmail.com',
    description: '유저 이메일',
    required: true,
  })
  ...
  @IsBoolean()
  @IsNotEmpty({ message: '관리자 여부를 선택해주세요.'})
  is_admin: boolean;
}